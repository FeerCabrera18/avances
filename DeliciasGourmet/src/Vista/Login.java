...
public class Login extends JFrame {
	...
	public Login() {
		...
		lblImagen.setIcon(new ImageIcon(Login.class.getResource("/Img/Fondo.png")));
		...
		lblEmail.setBounds(264, 172, 72, 31);
		panelContenedor.add(lblEmail);

		txtEmail = new JTextField();
		txtEmail.setBounds(125, 212, 350, 30);
			...
			public void actionPerformed(ActionEvent e) {
				try {
					if (verificarCampos()) {
						...
						JOptionPane.showMessageDialog(Login.this, "Bienvenido!", "Éxito",
